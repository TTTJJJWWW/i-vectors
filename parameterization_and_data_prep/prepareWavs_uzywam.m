clear;
path = '/storage/dane/jgrzybowska/bazyaudio/uzywammojegoglosujakoklucza/recs';
path_to_write = '/storage/dane/jgrzybowska/bazyaudio/uzywammojegoglosujakoklucza/merged';
addpath(path);
...
for i=1:n-1
   ...
   audiowrite([path_to_write '/' folders_new{i,1} '.wav'], signal, fs);
